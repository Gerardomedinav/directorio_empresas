...
export default function Show({ empresa, relacionadas = [], todas_las_empresas = [] }) {
    ...
    if (!empresa) return <div className="p-20 text-center">Cargando...</div>;
    ...
    return (
        <>
            ...
            <GradientBackground backdropBlurAmount="xl" className="min-h-screen bg-white/10 pb-20">
                ...
                {/* NAVBAR SIMPLE */}
                <nav className="bg-white/60 backdrop-blur-xl border-b border-white/10 sticky top-0 z-[100] px-6 py-4">
                    <div className="max-w-7xl mx-auto flex items-center justify-between">
                        <Link href="/" className="text-2xl font-black text-blue-700">FORMOSA <span className="text-gray-400 font-light">DIR</span></Link>
                        <Link href="/" className="text-sm font-bold text-gray-600 hover:text-blue-600">Volver al inicio</Link>
                    </div>
                </nav>
